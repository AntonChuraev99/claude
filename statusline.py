...
# Width maths and console probing are shared with the SessionStart hooks — see
# lib/term.py. Importing a local module costs a stat plus a cached .pyc read,
# which is an order of magnitude below the subprocess this render used to need.
sys.path.insert(0, os.path.join(HERE, "lib"))
from term import (  # noqa: E402  (path must be set before the import)
    DIM, ELLIPSIS, FALLBACK_COLS, GREEN, RED, RESET, YELLOW,
    dtrunc, dwidth, strip_ansi, terminal_cols,
)
