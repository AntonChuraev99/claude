...
- Любые правки документации, даже опечатки, и написание новых доков → главный по скиллу `doc-task`; ты только сообщаешь, что и где разошлось
