...
| ~~MCP `sentry`~~ **возвращён 2026-09-07** | Sentry issues | на дату ревизии: 1 (`authenticate`), не авторизован с 08-28 | — уже стоит (user-scope, `.claude-work/.claude.json`), авторизован 09-07 |
